...
CATEGORY_MAP = {
    ...
    "bebidas":                               {"en": "Beverages",                                  "id": "Minuman"},
    ...
    "climatizacao":                          {"en": "Air Conditioning & Climate",                 "id": "Pendingin & Pengatur Suhu"},
    "consoles_games":                        {"en": "Consoles & Games",                           "id": "Konsol & Game"},
    ...
    "cool_stuff":                            {"en": "Cool Stuff",                                 "id": "Barang Unik & Menarik"},
    ...
    "eletroportateis":                       {"en": "Portable Electronics",                       "id": "Elektronik Portabel"},
    ...
    "industria_comercio_e_negocios":         {"en": "Industry, Commerce & Business",              "id": "Industri, Perdagangan & Bisnis"},
    ...
    "moveis_cozinha_area_de_servico_jantar_e_jardim": {"en": "Kitchen, Laundry, Dining & Garden Furniture", "id": "Furnitur Dapur, Area Servis, Makan & Taman"},
    "moveis_decoracao":                      {"en": "Furniture & Decoration",                     "id": "Furnitur & Dekorasi"},
    "moveis_escritorio":                     {"en": "Office Furniture",                           "id": "Furnitur Kantor"},
    "moveis_quarto":                         {"en": "Bedroom Furniture",                          "id": "Furnitur Kamar Tidur"},
    ...
    "pcs":                                   {"en": "PCs & Computers",                            "id": "PC & Komputer"},
    ...
    "sinalizacao_e_seguranca":               {"en": "Signage & Security",                         "id": "Sinyal & Keamanan"},
